                        ...
                        <div class="card card-widget">
                            <div class="card-header">
                                <div class="user-block">
                                    ...
                                    <span class="username"><a href="#">{{$debate->user_publicacion}}</a></span>
                            ...
                            <div class="card-body">
                                ...
                                @else
                                <img src="/storage/{{$debate->file_path_publicacion}}" class="rounded mx-auto d-block" width="300">
                                @endif
                                ...
                                <span class="float-right text-muted">45 likes - comentarios</span>
                            </div>
                            <!-- /.card-body -->
